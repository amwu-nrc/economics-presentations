...
## What is Economics?
::: notes
Capitalism has been the dominant mode of production in Australia and the western world for most of modern history. 

So much so that you'll often hear arguments referring to "economics 101" like it is so simple and so natural. 

When problems arise (inequality, unemployment, housing affordability, the cost of living) it is natural to seek solutions which fit within the boundaries and assumptions set by capitalism. But capitalism is not the inevitable or ultimate model of an economy. Problems caused by capitalism do not have to be solved by capitalism.
:::
- What we call economics today only refers to one kind of economics - the economics of capitalism. 
- Capitalism is the mainstream branch of economics.
- It is hard to imagine other forms that our economy could take. 


## A (Brief) History of Economics
The way the economy has been structured has changed over human history:
...
-   Class is defined by the relationship between a person and the "means of production". 
-   Capitalists understand the importance of class solidarity.
-   Working class solidarity has been undermined by decades of neoliberal policy. 
