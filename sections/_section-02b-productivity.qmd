...
national_accounts_20 |> 
  ...
  scale_x_date(breaks = plot_date_range(national_accounts_20),
               date_labels = "%e %b\n%Y") +
  labs(title = "Declining Productivity Growth",
       subtitle = "20-Year Average Productivity Growth",
      x = NULL,
      y = NULL) + 
  theme_nrc()
```
...
productivity_sector |> 
  ...
  geom_line() +
  scale_colour_nrc() +
  gghighlight(industry %in% c("ALL INDUSTRIES", "Manufacturing", "Mining"), line_label_type = "ggrepel_text") +
  theme_nrc() +
  labs(title = "Industry Productivity",
