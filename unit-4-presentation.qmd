...
## The case for tariffs in the US
...
## Tariffs - Protectionism and Industrialisation
...
America is a special case. They maintain economic, political, and military power over much of the rest of the world - especially across the west.

Even if it works for them, it is not going to be a viable strategy for the less powerful countries.
:::
...
-   America can probably extract concessions from the vassal states like South Korea and Japan
    ...
    -   These concessions won't be big enough to restore US manufacturing.

-   Western de-industrialisation is mostly related to employment, rather than output.

-   Labour costs were reduced by off-shoring, but profit (and output) of western firms remained high.

-   Globalisation means value chains are now spread across the world.
...
-   Without significant investment into domestic manufacturing, demand can't actually be met by local industry.
    ...
    -   Investment and onshoring would require manufacturing firms to accept lower profits. Will they?

## Tariffs - Response to Declining Profit
...
-   Seeking constant productivity growth, capitalist investment focuses on machinery and technology at the expense of labour.

-   Because only labour can produce value, profitability is reduced.

-   US tariffs are thus a response to declining profit, intended to protect US capital from more productive/lower cost competitors, and to shift the burden of declining profitability off shore.
...
-   Capital is not inherently 'productive' - which means profit must represent the capture of the surplus that workers produce. \## The capitalist class / the working class
